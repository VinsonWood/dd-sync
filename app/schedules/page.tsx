...
export default function SchedulesPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
            ...
            <main className="max-w-7xl mx-auto px-4 py-6 sm:py-8 pt-16 lg:pt-8">
                {/* 调度器状态卡片 */}
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
                    ...
                    {logs.length === 0 ? (
                        ...
                        <>
                            {/* 移动端卡片视图 */}
                            <div
                                className="lg:hidden divide-y divide-gray-200 dark:divide-gray-700 overflow-y-auto"
